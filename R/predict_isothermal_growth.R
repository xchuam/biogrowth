...
predict_isothermal_growth <- function(model_name, times, model_pars, check = TRUE) {
    ...
    logN <- switch(model_name,
           ...
           Three_phase = trilinear_model(times, model_pars$logN0, model_pars$mu,
                                       model_pars$lambda,model_pars$logNmax),
           Two_phase = twolinear_model(times, model_pars$logN0, model_pars$mu,
                                       model_pars$lambda),
           Expo_station = twolinear_no_lag_model(times, model_pars$logN0, model_pars$mu,
                                       model_pars$logNmax),
           One_phase = linear_model(times, model_pars$logN0, model_pars$mu),
